<template>
  <div class="auth-form">
    <div class="auth-inner-wrapper">
      <h1> Sign up to begin sharing goods and services with NPOs around the world</h1>
      <ul id="error-list">
        <li class="error-msg">
          {{errors}}
        </li>
      ...
      <div class="form-name form">
        ...
        <input type="text" placeholder="What's your orginizations name?" @keydown.enter="login" v-model="user.username">
      </div>
